...
var properties = [ 'position', 'left', 'top', 'right', 'bottom', 'width', 'height', 'borderRadius', 'border', 'borderLeft',
	'borderTop', 'borderRight', 'borderBottom', 'borderColor', 'display', 'overflow', 'maxHeight', 'margin', 'marginLeft', 'marginTop', 'marginRight', 'marginBottom', 'padding', 'paddingLeft', 'paddingTop', 'paddingRight', 'paddingBottom', 'color',
	'background', 'backgroundColor', 'opacity', 'fontSize', 'fontWeight', 'textAlign', 'textDecoration', 'textTransform', 'cursor', 'visibility', 'zIndex' ];
...
UIRowShelf.prototype.constructor = UIRowShelf;
...
UIUnsplashImage.prototype.constructor = UIUnsplashImage;
...
var UILazyVideo = function ( img, src ) {
	...
	this.dom.addEventListener( 'mouseenter', function () {
		...
		scope.progress = new ProgressBar.Line( scope.dom, {
			...
			duration: 5000,
			color: '#FFEA82',
			svgStyle: { width: '100%', position: 'absolute', top: '0', left: '0' }
		} );
...
UILazyVideo.prototype.constructor = UILazyVideo;
...
UIMyLazyVideo.prototype.constructor = UIMyLazyVideo;
...
export { UIElement, UISpan, UIDiv, UILink, UIRow, UIRowShelf, UIPanel, UIText, UIImage, UIUnsplashImage, UIImageButton, UILazyImage, UIVideo, UILazyVideo, UIMyLazyVideo, UIInput, UITextArea, UISelect, UICheckbox, UIRadioButton, UIColor, UINumber, UIInteger, UIBreak, UIHorizontalRule, UIButton, UITabbedPanel, UIListbox, UILottieBox };
