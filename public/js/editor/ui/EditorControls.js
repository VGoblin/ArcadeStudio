...
class EditorControls extends THREE.EventDispatcher {
	...
	constructor( object, domElement ) {
		...
		this.applyKeyBoardMovement = function (delta) {
			...
			if ( this.moveUp ) this.camera.translateY( this.actualMoveSpeed );
			if ( this.moveDown ) this.camera.translateY( - this.actualMoveSpeed );
		}
		...
		this.onKeyDown = function (event) {
			...
			switch (event.keyCode) {
				...
				case 87: /*W*/
					if (!((IS_MAC ? event.metaKey : event.ctrlKey) || event.shiftKey)) {
