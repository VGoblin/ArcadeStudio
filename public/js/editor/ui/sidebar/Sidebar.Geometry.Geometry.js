import { UIRow, UIText, UIDiv } from '../components/ui.js';
...
function SidebarGeometryGeometry( editor ) {
	...
	verticesRow.add( new UIText( strings.getKey( 'sidebar/geometry/geometry/vertices' ) ) );
	...
	facesRow.add( new UIText( strings.getKey( 'sidebar/geometry/geometry/faces' ) ) );
	facesRow.add( faces );
