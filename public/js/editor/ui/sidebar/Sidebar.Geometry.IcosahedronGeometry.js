...
function SidebarGeometryIcosahedronGeometry( editor, object ) {
	...
	radiusRow.add( new UIText( strings.getKey( 'sidebar/geometry/icosahedron_geometry/radius' ) ) );
	...
	detailRow.add( new UIText( strings.getKey( 'sidebar/geometry/icosahedron_geometry/detail' ) ) );
