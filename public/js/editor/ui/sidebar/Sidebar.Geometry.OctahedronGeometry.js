...
function SidebarGeometryOctahedronGeometry( editor, object ) {
	...
	radiusRow.add( new UIText( strings.getKey( 'sidebar/geometry/octahedron_geometry/radius' ) ) );
	...
	detailRow.add( new UIText( strings.getKey( 'sidebar/geometry/octahedron_geometry/detail' ) ) );
