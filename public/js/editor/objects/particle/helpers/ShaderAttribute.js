import { BufferAttribute, DynamicDrawUsage, StaticDrawUsage } from "../../../libs/three.module.js";
...
ShaderAttribute.prototype._createBufferAttribute = function ( size ) {
	...
	if ( this.bufferAttribute !== null ) {
      ...
      this.bufferAttribute.array.length / this.bufferAttribute.itemSize;
		this.bufferAttribute.needsUpdate = true;
		return;

	}

	this.bufferAttribute = new BufferAttribute(
