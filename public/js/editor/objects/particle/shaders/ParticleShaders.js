import { ShaderChunk } from "../../../libs/three.module.js";

var particle_shader_vertex = `
	// Setup
...
var particle_shader_vertex_functions = `
	// From:
...
var particle_shader_attributes = `
...
var particle_shader_branch_avoiding = `
...
var particle_shader_rotate_texture = `
	// Rotate Texture
...
var ParticleShaders =
{
	vertex:
	[
		particle_shader_defines,
		particle_shader_uniforms,
		particle_shader_attributes,
		particle_shader_varyings,

		ShaderChunk.common,
		ShaderChunk.logdepthbuf_pars_vertex,
		ShaderChunk.fog_pars_vertex,

		particle_shader_branch_avoiding,
		particle_shader_vertex_functions,
		
		"void main() {", 
		
		particle_shader_vertex,
	...
	[
		...
		particle_shader_rotate_texture,
